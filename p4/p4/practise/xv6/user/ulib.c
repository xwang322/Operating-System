...
// because we are using malloc and free, we are simply copy everything in umalloc.c to here
// and then comment out umalloc.c contents
...
// p4b added for thread_create and thread_join
int 
thread_create(void(*start_routine)(void*), void *arg)
{
  ...
  int thd_create;
  thd_create = clone(start_routine, arg, stack);
  return thd_create;
}
